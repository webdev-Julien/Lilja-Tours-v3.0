---
title: "Histoire Volcanique Récente de Reykjanes : Comprendre la Nouvelle Ère Volcanique d'Islande"
...
À ce stade, le schéma était devenu clair. Le système volcanique de Fagradalsfjall produisait des éruptions régulières, chacune accessible aux visiteurs disposés à faire la randonnée. La proximité des trois sites a créé un champ volcanique en expansion où vous pouviez marcher sur de la lave de 2021, 2022 et 2023 en une seule randonnée.
...
Contrairement aux éruptions de 2021-2023, les autorités n'ont pas ouvert ces sites d'éruption à l'accès public au sol (sauf celle de l'été 2025). La proximité des zones peuplées, la nature imprévisible de l'activité et le déclenchement rapide rendaient l'observation au sol trop dangereuse. Les circuits en hélicoptère ont fourni le seul moyen pour les visiteurs d'assister à ces éruptions de près. En savoir plus sur [comment voir la lave en Islande](/fr/blog/comment-voir-lave-islande/) avec l'activité volcanique actuelle.
