...
export const translations = {
  en: {
    ...
    footer: {
      ...
      leaveReview: "Traveled with us?",
      leaveReviewSubtitle: "Leave us a review",
  ...
  fr: {
    ...
    footer: {
      ...
      leaveReview: "Vous avez voyagé avec nous ?",
      leaveReviewSubtitle: "Laissez-nous un avis",
      tripAdvisor: "TripAdvisor",
      googleReview: "Google",
      trustPilot: "TrustPilot",
...
export const urls = {
  ...
  transfers: {
    en: "/transfers-iceland/",
    fr: "/fr/transferts-islande/",
  },
  experiences: {
