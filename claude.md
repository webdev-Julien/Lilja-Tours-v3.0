...
- For blog articles, you are in charge of all the datas in the frontmatter. You must consistently always use the same schema for the frontmatter across articles. Regarding the body, I will first write the article myself, when prompted to, you will adapt the text following other general guidelines provided here. Keep the structure as much as possible. You will also have to add links to other pages of the website according to the body content, and add pictures too.
